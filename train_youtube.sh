...
g++ -lm -pthread -march=native -Wall -funroll-loops -ffast-math -Wno-unused-result line.cpp -o line -I/usr/local/include/ -L /usr/local/lib/ -lgsl -lgslcblas
#-lgsl -lgslcblas
#g++ -lm -pthread -march=native -Wall -funroll-loops -ffast-math -Wno-unused-result reconstruct.cpp -o reconstruct
#g++ -lm -pthread -march=native -Wall -funroll-loops -ffast-math -Wno-unused-result normalize.cpp -o normalize
#g++ -lm -pthread -march=native -Wall -funroll-loops -ffast-math -Wno-unused-result concatenate.cpp -o concatenate
